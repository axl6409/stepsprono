...
const Teams = () => {
  ...
  return (
    <div className="inline-block w-full h-auto">
      ...
      <div className="relative border-t-2 border-b-2 border-black overflow-hidden py-8 px-2 pt-12 bg-flat-yellow">
        ...
        <ul className="flex flex-col justify-start">
          {teams.map(team => (
            <li className="flex flex-row p-1.5 border-2 border-black rounded-l bg-white shadow-flat-black" key={team.id}>
