...
const TeamPlayers = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl font-black mt-8 uppercase relative w-fit mx-auto">Liste des joueurs
        <span
        ...
        <ul className="w-10/12 mx-auto">
          {players.map(player => (
            <li key={player.playerId}>
              <p><span className="font-bold">{player.Player.firstname}</span> <span>{player.Player.lastname}</span></p>
            </li>
          ))}
        </ul>
      </div>
