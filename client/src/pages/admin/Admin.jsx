      ...
      <div className="py-4 block">
        ...
        <div className="flex flex-row flex-wrap justify-evenly items-center mb-8">
          ...
          <div className="w-1/2 px-3">
            ...
            >
            <span
              className="relative z-[2] w-full block border-2 border-black text-black px-3 py-2 rounded-full text-center shadow-md bg-white transition -translate-y-2 group-hover:-translate-y-0">Journées Thèmes</span>
            </Link>
          </div>
          {user && user.role === 'admin' && (
            <div className="w-1/2 px-3">
