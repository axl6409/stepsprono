  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border border-black p-4 rounded-xl shadow-flat-black bg-white">
        <h4 translate="no" className="font-bold text-black font-rubik text-base uppercase mb-2">Paires formées :</h4>
        {pairs.length === 0 ? (
          <p translate="no" className="text-gray-800">Aucune paire pour l’instant</p>
        ) : (
