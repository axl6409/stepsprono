...
const Pronostic = ({ match, userId, closeModal, isModalOpen }) => {
          ...
          {match && (
            <form
              ...
              <div className="flex flex-row justify-evenly mb-4">
                <label className={`label-element relative w-1/4 cursor-pointer ${selectedTeam === match.HomeTeam.id ? 'checked' : ''}`}>
                  <input
                    type="radio"
                  ...
                  />
                  <img className="border-2 border-black relative z-[2] bg-white" src={match.HomeTeam.logoUrl} alt={`${match.HomeTeam.name} Logo`} />
                </label>
                <label className={`label-element relative w-1/4 cursor-pointer ${selectedTeam === "null" ? 'checked' : ''}`}>
                  <input
                    type="radio"
                    value="null"
                    className="hidden"
                ...
                <label className={`label-element relative w-1/4 cursor-pointer ${selectedTeam === match.AwayTeam.id ? 'checked' : ''}`}>
                  <input
                    type="radio"
                  ...
                  />
                  <img className="border-2 border-black relative z-[2] bg-white" src={match.AwayTeam.logoUrl} alt={`${match.AwayTeam.name} Logo`} />
                </label>
              </div>
