...
const AnimatedTitle = ({ title }) => {
  ...
  return (
    <h1
      className={`font-black my-8 mt-0 uppercase transition-all duration-500 text-center ease-in-out relative w-fit mx-auto ${animateTitle ? 'title-animated' : 'text-base'}`}>
