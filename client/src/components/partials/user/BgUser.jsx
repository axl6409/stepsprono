...
const BgUser = () => {
  ...
  return (
    <div className="bg-user absolute inset-0 z-[1]">
      ...
      <img className="absolute top-2/3 -left-4" src={iconUserOpacity} alt=""/>
      <img className="absolute top-2/3 -right-12 w-32" src={iconUserOpacity} alt=""/>
      <img className="absolute bottom-1/4 -left-8" src={iconUserOpacity} alt=""/>
      <img className="absolute bottom-1/4 -right-8" src={iconUserOpacity} alt=""/>
    </div>
  )
}
