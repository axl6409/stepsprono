...
const AlertModal = ({ message, type }) => {
  ...
  return (
    <div className={`modal-error fixed z-[30] w-11/12 left-1/2 translate-x-[-50%] top-1/2 translate-y-[-50%]`}>
      ...
      <div className={`relative p-4 w-full h-auto border border-black rounded-xl z-[2] bg-white`}>
        <img className="w-[50px] block mx-auto" src={`${type === 'error' ? incorrectIcon : correctIcon}`} alt=""/>
