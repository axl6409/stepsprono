...
const AdminTeams = () => {
  ...
  return (
    <div className="inline-block w-full h-auto">
      ...
      <h1 className="text-3xl font-black my-8 uppercase relative mx-auto text-center w-11/12">Données des équipes
      ...
      <div className="pb-3.5 pt-6 px-2 bg-black relative">
        ...
        <div className="w-fit absolute -top-5 right-2.5 rounded-full">
          <button
