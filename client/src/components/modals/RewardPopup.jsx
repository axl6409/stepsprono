...
const RewardPopup = ({ reward, apiUrl, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[501]" onClick={handleClickOutside}>
      <div className="relative w-full h-full flex items-center justify-center">
        <div className="absolute z-[9] fade-in inset-0 h-full w-full bg-gray-600 bg-clip-padding backdrop-filter backdrop-blur-[4px] bg-opacity-40 border-2 border-grey-light rounded-[18px] blur-[2px]"></div>
        <div ref={popupRef} className="relative fade-in delay-1000 z-10 bg-white w-11/12 py-4 px-4 rounded-xl border border-black shadow-flat-black">
